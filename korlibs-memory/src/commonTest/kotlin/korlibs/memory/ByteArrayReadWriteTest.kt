...
class ByteArrayReadWriteTest {
    ...
    @Test
    fun test2() {
        assertEquals("000123456789abcdef", ByteArray(9).apply { set64BE(1, 0x0123456789ABCDEFL) }.toHexString())
        assertEquals("00efcdab8967452301", ByteArray(9).apply { set64LE(1, 0x0123456789ABCDEFL) }.toHexString())
    }
}
