...
/** Returns the float representation of [this] memory bits */
internal fun Long.reinterpretAsDouble(): Double = Double.fromBits(this)

/** Returns the bits in memory of [this] float */
internal fun Float.reinterpretAsInt(): Int = this.toRawBits()
/** Returns the bits in memory of [this] float */
internal fun Double.reinterpretAsLong(): Long = this.toRawBits()
...
internal fun Int.extract4(offset: Int): Int = (this ushr offset) and 0b1111
