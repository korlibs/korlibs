...
object Win32AudioSystem : AudioSystem() {
...
internal class Win32WaveOutSoftAudioPlayer(override val device: AudioDevice) : SoftAudioSystem(WaveOutAudioStreamPlayer(device)) {
    companion object {
