...
class CaseSensitiveTest {
    ...
    private val condResources: () -> Boolean = { cond() && runBlockingNoJs { resourcesVfs.isCaseSensitive() } }
    private val condLocal: () -> Boolean = { cond() && runBlockingNoJs { rootLocalVfs.isCaseSensitive() } }
