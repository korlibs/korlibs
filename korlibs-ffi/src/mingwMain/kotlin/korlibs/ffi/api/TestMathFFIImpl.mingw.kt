...
private fun callbackQsortCompare0(p0: COpaquePointer?, p1: COpaquePointer?): Int =
    fun_Callback_qsort_compare[0]!!.func(p0.toFFIPointer(), p1.toFFIPointer())

private fun callbackQsortCompare1(p0: COpaquePointer?, p1: COpaquePointer?): Int =
    fun_Callback_qsort_compare[1]!!.func(p0.toFFIPointer(), p1.toFFIPointer())

private fun callbackQsortCompare2(p0: COpaquePointer?, p1: COpaquePointer?): Int =
    fun_Callback_qsort_compare[2]!!.func(p0.toFFIPointer(), p1.toFFIPointer())

private fun callbackQsortCompare3(p0: COpaquePointer?, p1: COpaquePointer?): Int =
    fun_Callback_qsort_compare[3]!!.func(p0.toFFIPointer(), p1.toFFIPointer())

private val fun_Callback_qsort_compare = arrayOfNulls<FFIFunctionRef<Function2<FFIPointer, FFIPointer, Int>>>(4)
