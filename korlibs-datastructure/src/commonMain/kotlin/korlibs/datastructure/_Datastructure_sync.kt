...
open class SynchronizedCollection<T>(
    ...
    override fun retainAll(elements: Collection<T>): Boolean = lock { base.retainAll(elements.toSet()) }
    override fun removeAll(elements: Collection<T>): Boolean = lock { base.removeAll(elements.toSet()) }
