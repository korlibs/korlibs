...
class ArrayExtTest {
    ...
    fun testVariants() {
        ...
        assertEquals(listOf(3, 4, 1, 2), charArrayOf(1.toChar(), 2.toChar(), 3.toChar(), 4.toChar()).rotatedRight(-2).map { it.code }.toList())
        ...
        assertEquals(listOf(4, 1, 2, 3), charArrayOf(1.toChar(), 2.toChar(), 3.toChar(), 4.toChar()).rotatedLeft(-1).map { it.code }.toList())
