...
actual class Lock actual constructor() : BaseLockWithNotifyAndWait {
    ...
    private var mutex: LongVarOf<pthread_mutex_t>? = null
    private var cond: LongVarOf<pthread_cond_t>? = null
    ...
    actual override fun lock() {
        ...
        //val mut = run {
            ...
            if (cond == null) {
                cond = arena!!.alloc<pthread_cond_tVar>().also {
                    pthread_cond_init(it.ptr, null)
                    //pthread_cond_destroy(cond.ptr)
                }
            }
            if (mutex == null) {
                mutex = arena!!.alloc<pthread_mutex_tVar>().also {
