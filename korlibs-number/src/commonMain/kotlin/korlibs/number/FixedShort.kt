...
import korlibs.number.internal.toIntRound
 ...
 */
@JvmInline
value class FixedShort private constructor(val raw: Short) : Comparable<FixedShort> {
    companion object {
...
fun Number.toFixedShort(): FixedShort = FixedShort(this.toDouble())
