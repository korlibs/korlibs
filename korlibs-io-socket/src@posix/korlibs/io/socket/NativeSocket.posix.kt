...
class NativeAsyncSocket(val socket: NativeSocket = NativeSocket()) : AsyncSocket {
...
class NativeAsyncServerSocket(val socket: NativeSocket, override val requestPort: Int, override val backlog: Int) : AsyncServerSocket {
	constructor(port: Int, host: String, backlog: Int, secure: Boolean) : this(NativeSocket(), port, backlog) {
